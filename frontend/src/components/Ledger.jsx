  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 8 }}>
        <span className="dim" style={{ fontSize: 12 }}>Running total</span>
        <span className="serif num" style={{ fontSize: 16 }}>
          {money(trip.running_total)} <span className="dim" style={{ fontSize: 12, fontFamily: "var(--font-body)" }}>/ {money(trip.budget_cap)} cap</span>
        </span>
      </div>
